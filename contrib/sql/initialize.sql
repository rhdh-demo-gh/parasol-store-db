...
INSERT INTO catalog (item_id, name, description, category, price, features, benefits) VALUES ('RHNL-017', 'Pay-As-You-Drive', 'This usage-based insurance product charges premiums based on the number of miles you drive. Ideal for infrequent drivers or those who use public transportation often, Pay-As-You-Drive adjusts your premiums monthly depending on your vehicle''s mileage. The less you drive, the more you save!', 4, 9.00,'','');
